...
import aao.algoritmos.SelectionSort;

public class SelectionSortTeste  extends BaseTeste {

	@BeforeEach
	void setUp(TestInfo testInfo) throws Exception {
		System.out.println("SelectionSortTeste." + testInfo.getDisplayName());
	}
	...
	void testeAmostra() {
		...
		SelectionSort classeOrd = new SelectionSort();
